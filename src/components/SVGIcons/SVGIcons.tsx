...
export const GitHubIcon: FC<ISVGIcon> = ({ width = 35, height = 35 }) => {
  return (
    <svg viewBox='0 0 24 24' fill='none' width={width} height={height} id='githubIcon' xmlns='http://www.w3.org/2000/svg' stroke=''>
...
export const CodeSandbox: FC<ISVGIcon> = ({ width = 35, height = 35 }) => {
  return (
    <svg
      fill='#eee'
      id='codeSandboxIcon'
